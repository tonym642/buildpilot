...
function hasContent(content_json) {
...
export default function BuildPanel({ isMobile, sections, activeSection, activeSectionId, setActiveSectionId, updateSectionContent, sectionFadeRef }) {
  return (
